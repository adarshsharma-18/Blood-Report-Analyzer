export const poseInstructions = {
    ...
    Child: [
        ...
        'Touch big toes together and sit back onto heels',
        'Separate knees hip-width apart and fold torso forward',
        'Extend arms forward or rest alongside body',
        <a target="blank" href="https://www.yogajournal.com/poses/child-s-pose/">Know More</a>
    ],
    Mountain: [
        'Difficulty:Easy',
        'Stand with feet together or hip-width apart',
        'Ground through all four corners of feet',
        'Engage thighs and lengthen tailbone downward',
        'Roll shoulders back and lift chest',
        <a target="blank" href="https://www.yogajournal.com/poses/mountain-pose/">Know More</a>
    ],
    CatCow: [
        'Difficulty:Easy',
        'Start on hands and knees in tabletop position',
        'Inhale arch back (Cow Pose): drop belly, lift chin/chest',
        'Exhale round spine (Cat Pose): tuck chin, draw belly in',
        'Continue flowing with breath for 5-10 cycles',
        <a target="blank" href="https://www.yogajournal.com/poses/cat-cow/">Know More</a>
    ],
    Corpse: [
        'Difficulty:Easy',
        'Lie flat on back with legs extended',
        'Arms at sides with palms facing up',
        'Relax entire body into mat',
        'Focus on natural breath for 5-10 minutes',
        <a target="blank" href="https://www.yogajournal.com/poses/corpse-pose/">Know More</a>
    ],
    ForwardBend: [
        'Difficulty:Medium',
        'Sit with legs extended straight forward',
        'Inhale lengthen spine, exhale hinge forward',
        'Hold ankles or shins (not knees)',
        'Keep neck aligned with spine',
        <a target="blank" href="https://www.yogajournal.com/poses/seated-forward-bend/">Know More</a>
    ],
    Bridge: [
        'Difficulty:Medium',
        'Lie on back with knees bent, feet hip-width',
        'Press into feet to lift hips toward ceiling',
        'Interlace hands under back to roll shoulders under',
        'Hold for 5-8 breaths then lower slowly',
        <a target="blank" href="https://www.yogajournal.com/poses/bridge-pose/">Know More</a>
    ],
    Easy: [
        'Difficulty:Easy',
        'Sit cross-legged with hands on knees',
        'Stack spine vertically from tailbone to crown',
        'Relax shoulders away from ears',
        'Option to meditate here for 5+ minutes',
        <a target="blank" href="https://www.yogajournal.com/poses/easy-pose/">Know More</a>
    ]
}
